...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_all)
```
...
```{r}
tar_read(follow_up_stats_males)
```
...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_males)
```
...
```{r}
tar_read(follow_up_stats_females)
```
...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_females)
```
...
```{r}
tar_read(follow_up_stats_under_65)
```
...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_under_65)
```
...
```{r}
tar_read(follow_up_stats_65_to_75)
```
...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_65_to_75)
```
...
```{r}
tar_read(follow_up_stats_75_and_over)
```
...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_75_and_over)
```
...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_under_65_males)
```
...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_under_65_females)
```
...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_65_to_75_males)
```
...
#| fig-width: 12
#| fig-height: 20
tar_read(spline_plots_combined_65_to_75_females)
```
...
## Sensitivity analysis - stratified by APOE-e4

### Non-carriers

```{r}
tar_read(pooled_estimates_APOE_non_carrier)
```

### Carriers

```{r}
tar_read(pooled_estimates_APOE_carrier)
```
